JOB_NAME = "7B_internlm2_roberta_cls"
...
MODEL_ONLY_FOLDER = "local:llm_ckpts/7B_internlm2_roberta_cls/xxxx"
# Ckpt folder format:
# fs: 'local:/mnt/nfs/XXX'
SAVE_CKPT_FOLDER = "local:llm_ckpts/7B_internlm2_roberta_cls"
LOAD_CKPT_FOLDER = "local:llm_ckpts/7B_internlm2_roberta_cls/49"
...
generation = dict(
    ckpt_folder="llm_ckpts/7B_internlm2_roberta_cls/60000",
    output_folder="generation/7B_internlm2_roberta_cls/60000",
    batch_size=1,
    eos_id=[2, 0],
    bos_id=1,
    max_length=100,
